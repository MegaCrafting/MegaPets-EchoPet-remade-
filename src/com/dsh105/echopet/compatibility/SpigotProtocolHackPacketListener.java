...
import com.dsh105.echopet.compat.api.util.WrapperPlayServerEntityMetadata;
import com.dsh105.echopet.compat.api.util.WrapperPlayServerSpawnEntityLiving;
    ...
    public void onPacketSending(PacketEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.SPAWN_ENTITY_LIVING) {
            ...
            if (entity != null && entity.hasMetadata(this.entityIdMetadataKey)) {
                ...
                wrapperPlayServerEntityMetadata.setMetadata(
                        fixMetadata(entityType, wrapperPlayServerEntityMetadata.getMetadata()));
            }
        }
    }
