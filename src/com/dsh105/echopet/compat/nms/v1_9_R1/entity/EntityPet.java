...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet {
    ...
    */
    ...
    public void onLive() {
        ...
        if (pet.isOwnerRiding() && this.passengers == null && !pet.isOwnerInMountingProcess()) {
    ...
    public void g(float sideMot, float forwMot) {
        ...
        EntityHuman human = (EntityHuman) this.passengers;
        ...
        this.lastYaw = this.yaw = this.passengers.yaw;
        this.pitch = this.passengers.pitch * 0.5F;
        this.setYawPitch(this.yaw, this.pitch);
        this.aI = this.aG = this.yaw;

        sideMot = ((EntityLiving) this.passengers).aZ * 0.5F;
        forwMot = ((EntityLiving) this.passengers).ba;
